...
<div class="container">
	<div class="row">
	  <div class="col text-left"><h3><a href="${ctp}/shop/input/productInput">상품등록하기</a></h3></div>
  ...
  <div class="text-center">
	  <form name="searchForm">
	    ...
	    <input type="button" value="상품검색" onclick="productSearch()" class="btn btn-secondary btn-sm"/>
	  </form>
	  <script>
