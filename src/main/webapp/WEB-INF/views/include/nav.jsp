...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="${ctp}/" class="w3-bar-item w3-button w3-padding-large w3-hide-small">PDS</a>
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        ...
        <a href="${ctp}/study/" class="w3-bar-item w3-button">연습1</a>
        <a href="${ctp}/study/" class="w3-bar-item w3-button">연습2</a>
        <a href="${ctp}/study/" class="w3-bar-item w3-button">연습3</a>
      </div>
    </div>
    <div class="w3-dropdown-hover w3-hide-small">
      <button class="w3-padding-large w3-button" title="More">mini쇼핑몰<i class="fa fa-caret-down"></i></button>     
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="${ctp}/shop/input/goodsMenu" class="w3-bar-item w3-button">대/중/소 분류</a>
