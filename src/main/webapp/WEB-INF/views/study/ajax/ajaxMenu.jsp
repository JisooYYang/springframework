...
<div class="container">
  ...
  <p>기본(String) : 
    ...
    <a href="${ctp}/study/ajax/ajaxTest2" class="btn btn-secondary">시(도)/구(동)(Array List의 String배열)</a> &nbsp;
    <a href="${ctp}/study/ajax/ajaxTest3" class="btn btn-secondary">시(도)/구(동)(HashMap형식으로 전달)</a> &nbsp;
  </p>
  <p>응용(vo) : 
    <a href="${ctp}/study/ajax/ajaxTest4" class="btn btn-secondary">회원아이디검색(VO/VOS활용)</a> &nbsp;
  </p>
</div>
<p><br/></p>
