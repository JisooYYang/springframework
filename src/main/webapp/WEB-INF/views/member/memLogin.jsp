		  ...
		  <div class="container p-3 border">
			  <form name="myForm" method="post" class="was-validated">
			    ...
			    <div class="form-group text-center">
				    ...
				    <button type="button" class="btn btn-secondary btn-sm" onclick="location.href='${ctp}/';">Back</button> &nbsp;
				    <button type="button" class="btn btn-secondary btn-sm" onclick="location.href='${ctp}/member/memJoin';">Join</button>
			    </div>
			    <div class="row" style="font-size:12px">
			      <span class="col"><input type="checkbox" name="idCheck" checked />Remember ID</span>
