...
//		return vos;		
	...
	public String ariaPost(String pwd) {
		...
		} catch (InvalidKeyException e) {	//key가 잘못되었을때 예외처리
			e.printStackTrace();
		} catch (UnsupportedEncodingException e) { //인코딩이 잘못되었을때 에외처리
			e.printStackTrace();
		}
	...
	public String securityCheckPost(String pwd) {
		...
		pwd = "Encoding : " + encPwd + " / Original password : " + pwd;
	...
	public String mailFormPost(MailVO vo) {
		try {
			...
			FileSystemResource file = new FileSystemResource("Y:\\JavaGreen\\springframework\\works\\javagreenS\\src\\main\\webapp\\resources\\images\\main.jpg");
