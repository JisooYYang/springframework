...
//			RedirectAttributes redirect, //model이랑 같이쓰면 model명령이 충돌됨.
...
//			redirect.addAttribute("mid", mid);
	...
	public String memJoinPost(MultipartFile fName, MemberVO vo) {
		...
		// 닉네임 체크
		if(memberService.getMemNickCheck(vo.getNickName()) != null) {
	...
	public String memNickCheckGet(String nickName) {
		String res = "0";
